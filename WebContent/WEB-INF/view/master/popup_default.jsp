	...
	<c:otherwise>
		<c:forEach var = "popup" items = "${listModel.list}">
			<tr>
				...
				<td width="10%" align="center"><a href="javascript:popDelete('${popup.pop_artid}');"><b>ⅹ</b></a></td>	                                       
			</tr>
		</c:forEach>
		</c:otherwise>
	</c:choose>
	...
	<tr align="center">
		<td>
			<c:if test = "$beginPage > 10}">
				<a href = "<c:url value = "/master/popup.do?p=${beginPage - 1}"/>">이전</a>
			</c:if>
			...
			<c:if test="${endPage < listModel.totalPageCount}">
				<a href="<c:url value="/master/popup.do?p=${endPage + 1}"/>">다음</a>
			</c:if>
		</td>
	</tr>
</table>
